...
class Ajax_pagination{
    ...
    var $cur_tag_open		= '<li><span class="current">';
    var $cur_tag_close		= '</span></li>';
    var $next_tag_open		= '<li class="next hidden-xs">';
    var $next_tag_close		= '</li>';
    var $prev_tag_open		= '<li class="previous hidden-xs">';
...
//					$('#". $this->div . "').hide().html(data).fadeIn(1000)" . $this->js_rebind ."; }); return false;\">"
//        . $text .'</a>';

        return "<a href=\"javascript:void(0);\"
		         " . $this->anchor_class . "
					onclick=\"pacakgeChangePage(".$count.",". $pageCount .");return false;\">"
        . $text .'</a>';
    }
