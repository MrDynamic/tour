...
<div class='panel-body'>
    <?php
		...
		$selectPackage = array('class'=>'form-control','id'=>'packageId','required'=>'');
...
//         $inputTitle = array('name'=>'title','id'=>'title','class'=>'form-control','required'=>'');
		...
		$action = 'admin/packagePicture/add';
// 		echo create_input(array('ชื่อภาพ','title'), $inputTitle);
		echo create_dropdown(array('แพคเก็จ','packageId'),'package_id',$package,$selectPackage);
