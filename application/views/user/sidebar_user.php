<div class="col-md-3 col-md-pull-9 sep-top-2x">
  ...
  <ul class="widget widget-cat">
    ...
    <li class="cat-item"><a href="<?=site_url('order/listOrder');?>" class="upper">รายการสั่งซื้อ</li>
    <li class="cat-item"><a href="<?=site_url('order/requestTourPage');?>" class="upper">จัดทัวร์</a></li>
    <li class="cat-item"><a href="<?=site_url('order/listRequestTour');?>" class="upper">รายการจัดทัวร์</a></li>
  </ul>
</div>