<div class="col-md-3 col-md-pull-9 sep-top-2x">
  ...
  <ul class="widget widget-cat">
    <li class="cat-item"><a href="#" class="upper">แก้ไขข้อมูลส่วนตัว</a></li>
    <li class="cat-item"><a href="#" class="upper">เปลี่ยนรหัสผ่าน</a></li>
    <li class="cat-item"><a href="#" class="upper">รายการสั่งซื้อ</li>
